...
class FullAppbar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Size get preferredSize =>
      Size.fromHeight(status_bar_height + ShortStoryReadStyle.appbar_height);
  ...
  Widget build(BuildContext context) {
    ...
    /// 右侧图标颜色（夜间模式与底部导航栏图标颜色一致，使用次要文字颜色降低视觉重量）。
    ...
    return Container(
      ...
      color: bg_color,
      child: SizedBox(
        height: ShortStoryReadStyle.appbar_height,
        child: Row(
          children: <Widget>[
                ...
                : GestureDetector(
                    ...
                    child: Padding(
                      ...
                      child: TweenAnimationBuilder<double>(
                        ...
                        child: SvgIcon(
                          name: is_favorited ? 'user_selected' : 'not_favorited',
                          width: 22,
                          height: 22,
                          color: is_favorited
